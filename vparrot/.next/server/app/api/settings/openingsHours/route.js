...
async function GET(request) {
    try {
        ...
        console.error("Erreur lors de la r\xe9cup\xe9ration des heures :", error);
        return new next_response/* default */.Z("Erreur interne du serveur", {
            status: 500
        });
    } finally{
...
var __webpack_exports__ = __webpack_require__.X(0, [3587,4937,5501,9335], () => (__webpack_exec__(1249)));
